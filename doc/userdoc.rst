...
1. To check that *CarlikeBot* description is working properly use following launch commands
   ...
   .. code-block:: shell
    ...
    ros2 launch ackdrive_px4_mrover view_robot.launch.py
...
2. To start *CarlikeBot* example open a terminal, source your ROS2-workspace and execute its launch file with
   ...
   .. code-block:: shell
    ...
    ros2 launch ackdrive_px4_mrover carlikebot.launch.py remap_odometry_tf:=true
...
5. If everything is fine, now you can send a command to *bicycle_steering_controller* using ROS 2 CLI:
   ...
   .. code-block:: shell
      ...
      [AckDriveMroverHardware]: Got position command: 0.03 for joint 'virtual_front_wheel_joint'.
      [AckDriveMroverHardware]: Got velocity command: 20.01 for joint 'virtual_rear_wheel_joint'.
